...
using LoadIterator = mgpu::lambda_iterator_t<LoadFunctor, mgpu::empty_t, ValueType, size_t>;

template <typename ValueType, typename LoadFunctor>
LoadIterator<ValueType, LoadFunctor> MakeLoadIterator(LoadFunctor load_functor, size_t base) {
